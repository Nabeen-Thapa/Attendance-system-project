...
if (mysqli_num_rows($attendance_result) > 0) {
    ...
    while ($attendance_row = mysqli_fetch_assoc($attendance_result)) {
        ...
        $pdf->Cell(40, 10, $attendance_row['std_name'], 1);
        $pdf->Cell(40, 10, $attendance_row['batch_name'], 1);
        $pdf->Cell(40, 10, $attendance_row['semester_name'], 1);
        $pdf->Cell(25, 10, $attendance_row['present_count'], 1);
        $pdf->Cell(25, 10, $attendance_row['absent_count'], 1);
        $pdf->Ln();
    }
