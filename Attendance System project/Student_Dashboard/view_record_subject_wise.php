...
try {
    ...
    $std_id= $_GET['std_id'];
    // echo "<script>alert('.$sem_id.' '.$sub_id.''.$sub_id.');</script>";
    ...
    INNER JOIN 
        ...
        and
        attendence_record_table.student_id ='$std_id'
    ...
    if (mysqli_num_rows($attendance_result) > 0) {
        ...
        echo "<center><h2>subject name : " .$sub_tilte. "</h2></center>";
        echo "<center><h3>Attendance total Record</h3></center>";
...
<!-- to show the student racord date wise -->
<?php
try {
    ...
    if (mysqli_num_rows($attendance_result) > 0) {
        ...
        echo "<center><h3>Attendance dates</h3></center>";
