...
if (isset($_POST['student_update_btn'])) {
    ...
    if ($error == 0) { 
        ...
        if (mysqli_query($connect, $update_query)) {
            ...
            header("location:Student_Dashboard/student_details.php");
        } else {
...
<head>
    ...
    <link rel="stylesheet" href="student_details_update_css.css" />
...
<body>
    ...
    <div class="wrapper">
        <form class="student_registration" action="<?php echo $_SERVER['PHP_SELF'] ?>"
            ...
            <a href="https://localhost/Attendance%20System%20project/Student_Dashboard/student_details.php"
