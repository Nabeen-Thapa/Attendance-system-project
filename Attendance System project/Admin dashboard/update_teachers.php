...
$teacher_id = $_GET['teacher_update_id'];
...
if (isset($_POST['teacher_add_btn'])) {
    ...
    if (isset($_POST['teacher_pwd']) && !empty($_POST['teacher_pwd']) && trim($_POST['teacher_pwd'])) {
        ...
        $teacher_error++;
        $teacher_pwd_err = 'Enter your pwd';
    }
    ...
    if (isset($_POST['teacher_confirm_pwd']) && !empty($_POST['teacher_confirm_pwd']) && trim($_POST['teacher_confirm_pwd'])) {
        ...
        $teacher_error++;
        $teacher_confirm_err = 'Enter your confirm_pwd';
    }
    if ($teacher_error == 0) {
        //password venerator
        ...
        include '../database and tables/create_database.php';
        $teacher_update = "UPDATE teacher_details SET Name='$teacher_name',Email= '$teacher_email',  Phone= '$teacher_phone', Username='$teacher_uname', address= '$teacher_address', Gender= '$teacher_gender',image= '$image' where id='$teacher_id'";
...
?>
    ...
    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
        <div class="teacher_registration">
            ...
            <div class="admin_view_image">your previous image <br>
                <img src="../Admin dashboard/teacher_images/<?php echo $teacher_data['image'] ?>">
            </div>
            <div>
